...
class _ReservationRepository implements ReservationRepository {
  ...
  Future<List<ReservationEntity>> getOrphanageReservation(
    ...
    final _options = _setStreamType<List<ReservationEntity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    late List<ReservationEntity> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
  ...
  Future<List<OrphanageReservationEntity>> getOrphanageVisitReservation(
    ...
    _headers.removeWhere((k, v) => v == null);
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<OrphanageReservationEntity>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<OrphanageReservationEntity> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
